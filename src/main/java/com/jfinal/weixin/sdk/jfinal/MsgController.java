...
//		log.debug("是否最后执行。。。");
    ...
    public String getInMsgXml() {
        ...
        if (StrKit.isBlank(inMsgXml)) {
            log.debug("请不要在浏览器中请求该连接,调试请查看WIKI:http://git.oschina.net/jfinal/jfinal-weixin/wikis/JFinal-weixin-app%E5%92%8C%E8%B0%83%E8%AF%95");
			throw new RuntimeException("请不要在浏览器中请求该连接,调试请查看WIKI:http://git.oschina.net/jfinal/jfinal-weixin/wikis/JFinal-weixin-app%E5%92%8C%E8%B0%83%E8%AF%95");
        }
        return inMsgXml;
    }
